...
type SubscriptionFirestore struct {
	...
	TrialEndsAt         string `json:"trial_ends_at,omitempty" firestore:"trial_ends_at"`
	RenewsAt            string `json:"renews_at,omitempty" firestore:"renews_at"`
	EndsAt              string `json:"ends_at,omitempty" firestore:"ends_at"`
