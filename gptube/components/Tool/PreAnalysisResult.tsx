        ...
        <div className="grid gap-6 lg:mx-48 sm:mx-10 lg:p-10 px-4">
            ...
            >
                <div className="flex justify-between">
                    ...
                    <Button type="primary" size="large" className="bg-blue-700 text-white p-1 order-last">
            ...
            >
                <div className="grid lg:gap-4 gap-2 mx-4">
                    <div className="flex gap-2">
                        <p className="text-white text-2xl font-medium">Como GitHub Copilot X te Potenciará como Programador (incluye GPT-4)</p>
                        <p className="text-xl font-medium text-red-600 border-[3px] border-red-600 p-1 h-fit rounded-lg">LIVE</p>
                    </div>
                    <div className="flex items-center justify-center gap-2 p-2 border-2 border-blue-600 rounded-lg w-fit">
                        <p className="text-xl sm:text-lg font-normal text-blue-600 px-1">Comments to analyze</p>
                        <p className="text-2xl font-bold text-blue-600">543.4K</p>
                    </div>
